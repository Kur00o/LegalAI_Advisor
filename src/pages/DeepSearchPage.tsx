...
import { ArrowLeft, Search, Upload, FileText, AlertTriangle, CheckCircle, Loader2, Download, Trash2, Info, Eye, EyeOff, AlertCircle, RefreshCw, Target, Globe, Book, Newspaper, Scale } from 'lucide-react';
